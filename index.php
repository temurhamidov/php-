...
//
//
//        echo 'Salom dustlar qalaysizlar';
//
//            echo "<br>";
//
...
//            $temur = "Salom dustlar ... qalaysizlar";
//
//            $abs = 'Hello friends, How are you';

//                  echo $temur, $abs;
//                  echo strlen($temur);
////                echo strlen($abs);

//                echo strcmp($temur, $abs);
//                  echo strpos($abs, "How");
//                  echo "<br>";
//                  echo strpos($temur, "dus");
//                    echo strtoupper($temur);
//                        echo trim($temur);
